...
public class Quiz implements ActionListener{
	...
	public Quiz() {
		...
		seconds_left.setFont(new Font("Ink Free",Font.BOLD,70));
		seconds_left.setBorder(BorderFactory.createBevelBorder(1));
		seconds_left.setOpaque(true);
		seconds_left.setHorizontalAlignment(JTextField.CENTER);
		seconds_left.setText(String.valueOf(seconds));
		
		time_label.setBounds(535,445,100,100);
		time_label.setBackground(new Color(25,25,25));
		time_label.setForeground(new Color(255,0,0));
		time_label.setFont(new Font("Calibri",Font.PLAIN,25));
		...
		number_right.setFont(new Font("Calibri",Font.PLAIN,45));
		...
		percentage.setFont(new Font("Calibri",Font.PLAIN,45));
